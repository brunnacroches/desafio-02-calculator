...
class RegistryThirdCalculatorViews:
    def registry_third_calculator_page(self) -> None:
        self.__clear()
    ...
    def registry_third_calculator_success(self, calculator_number: any) -> None:
        self.__clear()
    ...
    def registry_third_calculator_fail(self) -> None:
        self.__clear()
